...
base_config = "/home/vision/Work/DataGen/DataGenAtworkSegmentation/configAtWork.toml"
...
def createSpecialObjectMods(special, config):
	...
	modZPos = 0.01 #ShuffleZPos([-0.3, -0.2], special, False, False)
	mods.append(modZPos)
...
def createObjectMods(objects, config):
	...
	modZPos = 0.1 #ShuffleZPos([-1.0, -0.01], objects, True, False)
	mods.append(modZPos)
