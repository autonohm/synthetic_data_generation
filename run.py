...
parser.add_argument('--img_dir', default='Test/rgb/', type=str, help="Path to Image Directory")
parser.add_argument('--bb_dir', default='Test/bbox_labels/', type=str, help="Path to Bbox Directory")
